...
def evaluation_boxplots(df_soprano: pd.DataFrame,
    ...
    ``df_soprano`` : pd.DataFrame
        Metrics Dataframe for soprano voice.
    ``df_alto`` : pd.DataFrame
        Metrics Dataframe for alto voice.
    ``df_tenor`` : pd.DataFrame
        Metrics Dataframe for tenor voice.
    ``df_bass`` : pd.DataFrame
        Metrics Dataframe for bass voice.
    ``title``: String
        Title for the plot
...
def voicing_boxplots(df_soprano: pd.DataFrame,
                     df_alto: pd.DataFrame,
                     df_tenor: pd.DataFrame,
                     df_bass: pd.DataFrame, title=''):
    
    """Plots voicing evaluation boxplots using ``matplotlib``.
